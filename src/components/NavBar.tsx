  ...
  return (
    <nav className="sticky top-0 bg-blue-900 shadow-md flex z-40 items-center p-4">
      <div className="max-w-5xl w-full mx-auto flex justify-between items-center">
        ...
        <div className={`md:flex md:items-center md:gap-6 md:w-auto ${isMenuOpen ? "block" : "hidden"} absolute top-16 left-0 w-full bg-blue-900 md:static md:bg-transparent md:top-0 md:relative md:flex-row`}>
          ...
          {loggedInUser ? (
            <div className="relative">
              <Button onClick={toggleDropdown} className="bg-inherit hover:bg-inherit mt-2 flex items-center">
